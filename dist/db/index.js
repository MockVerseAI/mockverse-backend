...
const connectDB = async () => {
    try {
        ...
        const clientOptions = {
            serverApi: { version: "1" }, // Type assertion since mongoose types don't exactly match our usage
        };
        ...
        loggerFallback.info("🍀 Pinged your deployment. You successfully connected to MongoDB!");
